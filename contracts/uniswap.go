...
// Uniswap is an auto generated Go binding around an GoChain contract.
type Uniswap struct {
...
// UniswapCaller is an auto generated read-only Go binding around an GoChain contract.
type UniswapCaller struct {
	contract *bind.BoundContract // Generic contract wrapper for the low level calls
}

// UniswapTransactor is an auto generated write-only Go binding around an GoChain contract.
type UniswapTransactor struct {
	contract *bind.BoundContract // Generic contract wrapper for the low level calls
}

// UniswapFilterer is an auto generated log filtering Go binding around an GoChain contract events.
type UniswapFilterer struct {
	contract *bind.BoundContract // Generic contract wrapper for the low level calls
}

// UniswapSession is an auto generated Go binding around an GoChain contract,
...
// UniswapCallerSession is an auto generated read-only Go binding around an GoChain contract,
...
// UniswapTransactorSession is an auto generated write-only Go binding around an GoChain contract,
...
// UniswapRaw is an auto generated low-level Go binding around an GoChain contract.
type UniswapRaw struct {
	Contract *Uniswap // Generic contract binding to access the raw methods on
}

// UniswapCallerRaw is an auto generated low-level read-only Go binding around an GoChain contract.
type UniswapCallerRaw struct {
	Contract *UniswapCaller // Generic read-only contract binding to access the raw methods on
}

// UniswapTransactorRaw is an auto generated low-level write-only Go binding around an GoChain contract.
