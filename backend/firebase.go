...
const (
	// TODO these should be stolen from collector most likely, sharing db
...
func (fs *FirestoreBackend) GetLiquidityByToken(ctx context.Context, token string, from, to time.Time, interval time.Duration) ([]*models.TokenBucket, error) {
	// TODO
